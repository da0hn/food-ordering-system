...
public class PaymentDomainServiceImpl implements PaymentDomainService {
  ...
  public PaymentEvent validateAndInitiatePayment(
    ...
    if (!failureMessages.isEmpty()) {
      ...
      return PaymentFailedEvent.newInstance(payment, failureMessages);
    }
    log.info("Payment is initiated for order id: {}", payment.getOrderId().getValue());
    payment.updateStatus(PaymentStatus.COMPLETED);
    return PaymentCompletedEvent.newInstance(payment);
  }
  ...
  public PaymentEvent validateAndCancelPayment(
    ...
    return PaymentCancelledEvent.newInstance(payment);
  }
}
